...
const About = () => {
  ...
  return (
    // main section 
    <section className="container mx-auto px-6 py-16 font-monst mt-20">
  <motion.div
  ...
  >
    ...
    <div className="space-y-6">
      ...
      {/* hii */}
          ...
          <motion.div
            className="grid grid-cols-3 gap-6 items-center mt-8"
            variants={fadeUp}
          >
            {/* Stats */}
            <div className="space-y-4 col-span-2">
              <div className="flex items-center gap-4">
                <div className="bg-[#00A3FF] text-white text-sm font-bold rounded-full w-8 h-8 flex items-center justify-center">
                  01
                </div>
                <div>
        ...
        <motion.div className="space-y-6" variants={fadeUp}>
          ...
          <div>
            ...
            <p className="text-[#777777] mt-2 font-monst">
              To provide disciplined, dependable, and professional security
              services that protect lives, property, and peace of mind across
              Houston and beyond.
            </p>
          </div>
        </motion.div>
